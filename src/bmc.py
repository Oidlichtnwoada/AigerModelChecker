        ...
        while True:
            if self.start_bmc(current_bound):
                ...
                while True:
                    ...
                    if 'UNSATISFIABLE' in output:
                        proof_tree, empty_clause_index = generator.generate_proof_tree(output)
                        next_interpolant = generator.compute_interpolant(first_clauses, second_clauses, proof_tree, empty_clause_index)
